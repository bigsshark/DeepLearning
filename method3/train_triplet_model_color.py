...
from generator import RPNGererator
...
val_path = './train_valid/valid_image_vid_model_color.txt'
...
if __name__ == "__main__":
    ...
    # 通过颜色和模型分类网络进行训练
        ...
        loss = Lambda(triplet_loss,output_shape=(1, ))([f_sls3_anchor, f_sls3_positive, f_sls3_negative])
    ...
    if SAVE_FILTERED_LIST:
        ...
        filtered_train_list_path = './train_valid/train_vehicleModelColor_list_filtered.txt'
    ...
    model.fit_generator(RPNGererator(train_data_lines, dic_train_data_lines,
                        ...
                        validation_data = RPNGererator(val_data_lines, { },
